...
export default function Products() {
  ...
  /**
   * OPEN ADD MODAL
   * Opens empty form to add new product
   */
  ...
  /**
   * OPEN EDIT MODAL
   * Opens form with existing product data
   */
   ...
   * Search works on name, category, and SKU
   */
  ...
  /**
   * GET STATUS COLOR
   * Returns appropriate color class based on stock status
   */
